                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="add-product-box">
                                        ...
                                        <div class="row reorder-xs">
                                            <div class="col-lg-8 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    <h2>Update Product <a href="{{ route('admin-prod-index') }}"
                                    ...
                                    <hr>
                                    <form class="form-horizontal" action="{{route('admin-prod-update',$prod->id)}}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control" id="flashsale" name="flashsale">
                                                    ...
                                                    <option value="0" {{$prod->flashsale == 0
                                                    ? "selected":""}}>No
                                                    </option>
                                                    <option value="1" {{$prod->flashsale == 1
                                                    ? "selected":""}}>Yes
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control" id="eorangemall" name="eorangemall">
                                                    ...
                                                    <option value="0" {{$prod->eorangemall == 0
                                                    ? "selected":""}}>No
                                                    </option>
                                                    <option value="1" {{$prod->eorangemall == 1
                                                    ? "selected":""}}>Yes
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control" id="orangebasket" name="orangebasket">
                                                    ...
                                                    <option value="0" {{$prod->orangebasket == 0
                                                    ? "selected":""}}>No
                                                    </option>
                                                    <option value="1" {{$prod->orangebasket == 1
                                                    ? "selected":""}}>Yes
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control" id="surpriseoffer" name="surpriseoffer">
                                                    ...
                                                    <option value="0" {{$prod->surpriseoffer == 0
                                                    ? "selected":""}}>No
                                                    </option>
                                                    <option value="1" {{$prod->surpriseoffer == 1
                                                    ? "selected":""}}>Yes
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control" id="chinabasket" name="chinabasket">
                                                    ...
                                                    <option value="0" {{$prod->chinabasket == 0
                                                    ? "selected":""}}>No
                                                    </option>
                                                    <option value="1" {{$prod->chinabasket == 1
                                                    ? "selected":""}}>Yes
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control" id="emi" name="emi">
                                                    ...
                                                    <option value="0" {{$prod->emi == 0
                                                    ? "selected":""}}>No
                                                    </option>
                                                    <option value="1" {{$prod->emi == 1
                                                    ? "selected":""}}>Yes
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox2">
                                                    <input type="checkbox" id="check10" name="pccheck"
                                                           value="1" {{$prod->product_condition != 0 ? "checked":""}}>
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control" name="vendor_id" required="">
                                                    ...
                                                    @foreach($providers as $provider)
                                                        <option value="{{$provider->id}}" {{$provider->id == $prod->user_id ? "selected":""}} >{{$provider->shop_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="current_photo">Current Featured
                                                Image*</label>
                                            <div class="col-sm-6">
                                                <img id="adminimg" src="{{asset('assets/images/'.$prod->photo)}}" alt=""
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox2">
                                                    <input type="checkbox" id="check11" name="shcheck"
                                                           value="1" {{$prod->ship != null ? "checked":""}}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" name="ship" id="ship_time"
                                                           ...
                                                           value=" {{ $prod->ship != null ? $prod->ship:"" }}"
                                                           type="text">
                                                </div>
                                            </div>
                                            <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox2">
                                                    <input type="checkbox" id="check2" name="scheck"
                                                           value="1" {{$prod->size != null ? "checked":""}}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="checkbox2">
                                                    <input type="checkbox" id="check9" name="colcheck"
                                                           value="1" {{$prod->color != null ? "checked":""}}>
                                                        ...
                                                        <div class="form-group  single-color">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="input-group colorpicker-component">
                                                                    <input type="text" name="color[]" value="{{$colr}}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea class="form-control" name="shortdescription"
                                                          ...
                                                          placeholder="Enter short Description">{{$prod->shortdescription}}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea class="form-control" name="description"
                                                          ...
                                                          placeholder="Enter Profile Description">{{$prod->description}}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="costprice">Product
                                                Current Cost* <span>(In {{$sign->name}})</span></label>
                                            <div class="col-sm-6">
                                                <input class="form-control" name="costprice" id="costprice"
                                                       placeholder="e.g 20" required=""
                                                       value="{{round($prod->costprice * $sign->value , 2)}}" type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="cprice" id="blood_group_display_name"
                                                       placeholder="e.g 20" required=""
                                                       value="{{round($prod->cprice * $sign->value , 2)}}" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="blood_group_display_name">Product
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="pprice" id="blood_group_display_name"
                                                       placeholder="e.g 25"
                                                       value="{{round($prod->pprice * $sign->value , 2)}}" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="blood_group_display_name">Product
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="stock" id="blood_group_display_name"
                                                       placeholder="e.g 15" value="{{$prod->stock}}" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea class="form-control" name="policy" id="policy" rows="5"
                                                          ...
                                                          placeholder="Enter Profile Description">{{$prod->policy}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="email"></label>
                                            <div class="col-sm-6">
                                                <div class="checkbox2">
                                                    <input type="checkbox" id="check12" name="secheck"
                                                           value="1" {{ ($prod->meta_tag != null || $prod->meta_description != null) ? 'checked':'' }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <textarea class="form-control" name="meta_description"
                                                              ...
                                                              placeholder="Enter Meta Description">{{$prod->meta_description}}</textarea>
                                                </div>
                                            </div>
                                            <br>
                                        </div>
                                                        ...
                                                        <div class="qualification-area">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-xs-4 col-sm-2">
                                                                    <label class="control-label"> Choose Your
                                                                        Color: </label>
                                                                </div>
                                                    ...
                                                    <div class="qualification-area">
                                                        <div class="form-group">
                                                            <div class="col-sm-5 col-md-offset-1">
                                                                <input class="form-control" name="features[]" id="title"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <select class="form-control" id="exclusive_offer" name="exclusive_offer">
                                                    ...
                                                    <option value="0" {{$prod->exclusive_offer == 0
                                                    ? "selected":""}}>No
                                                    </option>
                                                    <option value="1" {{$prod->exclusive_offer == 1
                                                    ? "selected":""}}>Yes
                                                    </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" placeholder="2018-09-10 11:33:36" name="salon_service_start_time" value="{{$prod->salon_service_start_time}}">
                                            </div>


                                            <div class="col-sm-3">
                                                <input type="text"  class="form-control" placeholder="2018-09-10 12:33:36" name="salon_service_end_time" value="{{$prod->salon_service_end_time}}">
                                            </div>

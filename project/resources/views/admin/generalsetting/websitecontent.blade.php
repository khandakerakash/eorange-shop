                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                        ...
                                        <form class="form-horizontal" action="{{route('admin-gs-contentsup')}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <input name="title" id="website_title" class="form-control" placeholder="Enter Website Title" required="" type="text" value="{{$data->title}}" {!!$gs->rtl == 1 ? "dir='rtl'":""!!}>
                                            </div>
                                          </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="disable/enable_about_page">RTL Version:</label>
                                            <div class="col-sm-3" style="margin-top: 6px;">
                                                        <span class="dropdown">
                                            <button id="Vendor" class="btn btn-{{$gs->rtl == 1 ? 'primary':'danger'}} product-btn dropdown-toggle btn-xs" type="button" data-toggle="dropdown" style="font-size: 14px;">{{$gs->rtl == 1 ? 'Activated':'Deactivated'}}
                                                <span class="caret"></span></button>
                                                        <ul class="dropdown-menu">
                                                            <li><a href="{{route('admin-gs-rtl',1)}}">Active</a></li>
                                                            <li><a href="{{route('admin-gs-rtl',0)}}">Deactive</a></li>
                                                        </ul>
                                                        </span>
                                            </div>
                                          </div>
                                  ...
                                  <input id="cp1" type="text" name="colors" value="{{$data->colors}}"  class="form-control"  />
                                    <span class="input-group-addon"><i></i></span>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="disable/enable_about_page">Disable/Enable Tawk.to *</label>
                                            <div class="col-sm-3">
                                                <label class="switch">
                                                  <input type="checkbox" name="is_talkto" value="1" {{$data->is_talkto == 1 ? "checked":"" }}>

                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                        <div class="row reorder-xs">
                                            <div class="col-lg-8 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    ...
                                                    <p>Dashboard <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Home Page Settings <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Home Page Video
                                                </div>
                                            </div>
                                        ...
                                        <form class="form-horizontal" action="{{route('admin-video-submit')}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" name="vid" id="admin_name" placeholder="https://www.youtube.com/watch?v=u3MY3vIw4Aw" required="" value="{{$data->vid}}" type="text">
                                            </div>
                                          </div> 
                                          <div class="form-group">
                                            ...
                                            <img src="{{ $data->vidimg ? asset('assets/images/'.$data->vidimg):'http://fulldubai.com/SiteImages/noimage.png'}}" alt="No Photo" style="height: auto; width: 100%" id="adminimg">
                                            </div>
                                          </div>
                                          <div class="form-group">

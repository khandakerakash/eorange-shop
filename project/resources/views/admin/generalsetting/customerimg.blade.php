                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                        <div class="row reorder-xs">
                                            <div class="col-lg-8 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    <h2>Review Background Image</h2>
                                                    <p>Dashboard <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Generel Settings <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Review Background Image
                                                </div>
                                            </div>
                                        ...
                                        <form class="form-horizontal" action="{{route('admin-gs-cimgup')}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                        <img style="width: 100%; height: auto;" id="adminimg" src="{{ $data->cimg ? asset('assets/images/'.$data->cimg):'http://fulldubai.com/SiteImages/noimage.png'}}" alt="" id="adminimg">      
                                            </div>
                                          </div>
                                          <div class="form-group">

                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="disable/enable_about_page">Disable/Enable Multiple Shipping *</label>
                                            <div class="col-sm-3">
                                                <label class="switch">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="disable/enable_about_page">Disable/Enable Shipping Information For Vendor *</label>
                                            <div class="col-sm-3">
                                                <label class="switch">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="disable/enable_about_page">Disable/Enable Affilate Bonus *</label>
                                            <div class="col-sm-3">
                                                <label class="switch">
                                                  <input type="checkbox" name="is_affilate" value="1" {{$data->is_affilate==1?"checked":""}}>
                                                  <span class="slider round"></span>
                                                </label>
                                            </div>
                                          </div>

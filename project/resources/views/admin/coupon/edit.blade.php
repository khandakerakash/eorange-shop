                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                        ...
                                        <form class="form-horizontal" action="{{route('admin-cp-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group" id="pa">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" name="price" id="price" placeholder="Enter Amount " required="" type="text" value="{{$data->price}}" style="width: 50%; display: inline;"><span style="display: inline; font-size: 16px;" id="pz"> $</span>
                                            </div>
                                          </div>
                                          @endif
                                          <div class="form-group">

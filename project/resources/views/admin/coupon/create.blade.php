                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                        <div class="row reorder-xs">
                                            <div class="col-lg-8 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    <h2>Create Coupon <a href="{{ route('admin-cp-index') }}" style="padding: 5px 12px;" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a></h2>
                                                    <p>Dashboard <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Coupon <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Create
                                                </div>
                                            </div>
                                        ...
                                        <form class="form-horizontal" action="{{route('admin-cp-create')}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <select {!!$gs->rtl == 1 ? 'dir="rtl"':''!!} class="form-control" name="type" id="ps" required>
                                          ...
                                          <div class="form-group" id="pa" style="display: none;">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" name="price" id="price" placeholder="Enter Amount " required="" type="text" value="" style="width: 50%; display: inline;"><span style="display: inline; font-size: 16px;" id="pz"> $</span>
                                            </div>
                                          </div>

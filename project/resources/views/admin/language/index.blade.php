                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                  <div class="add-product-box">
                                    <div class="product__header">
                                      ...
                                      <hr>
                                    <form action="{{route('admin-lung-update')}}" method="POST">
                                      {{csrf_field()}}
                                      <div class="add-product-header products" style="justify-content: unset;">
                                        <label class="control-label" for="about_page_content" style=" padding-top: 10px;">Disable/Enable Language *</label>
                                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <label class="switch" style="padding-top: 5px">
                                        <input type="checkbox" name="is_language" value="1" {{$gs->is_language==1?"checked":""}}>
                                            ...
                                            @foreach($datas as $data)                                                
                                              <tr role="row" class="odd">
                                                      ...
                                                      <td>
                                                        ...
                                                        <a href="{{route('admin-lang-delete',$data->id)}}" class="btn btn-danger product-btn"><i class="fa fa-trash"></i> Remove</a>
                                                      </td>
                                                  </tr>
                                                  @endforeach
                                                  </tbody>
...
<script type="text/javascript">
  $( document ).ready(function() {
        $(".add-button").append('<div class="col-sm-4 add-product-btn text-right">'+
          ...
          '<i class="fa fa-plus"></i> Create New Language</a>'+
          '</div>');                                                                       
});
</script>

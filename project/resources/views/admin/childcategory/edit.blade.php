                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                     ...
                                     @endforeach
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6"> 
                                            <select  class="form-control" name="parent_id" id="subcat" required="">
                                                  <option value="">Select Sub Category</option>
                                            @foreach($subcatList as $sub)
                                            <option value="{{$sub->id}}" {{$sub->id == $childcat->parent_id ? "selected":""}}>{{$sub->name}}</option>
                                            @endforeach
                                              </select>
                                            </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" name="name" id="edit_blood_group_display_name" placeholder="Enter Category Name" required="" type="text" value="{{$childcat->name}}" >
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="edit_blood_group_slug">Slug* <span>(In English)</span></label>
                                            <div class="col-sm-6">
                                              <input class="form-control" name="slug" id="edit_blood_group_slug" placeholder="Enter Category Slug" required="" type="text" value="{{$childcat->slug}}" >
                                            </div>
                                          </div>  
                                            <hr>

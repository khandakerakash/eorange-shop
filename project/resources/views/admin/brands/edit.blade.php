                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="add-product-box">
                                        ...
                                        <div class="row reorder-xs">
                                            <div class="col-lg-8 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    <h2>Update Brand <a href="{{ route('admin-img-index') }}"
                                    ...
                                    <hr>
                                    <form class="form-horizontal" action="{{route('admin-img-edit',$ad->id)}}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="name" id="b1"
                                                       placeholder="enter brand name" value="{{$ad->name}}"
                                                       type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="url" id="b1"
                                                       placeholder="https://www.google.com" value="{{$ad->url}}"
                                                       type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <img src="{{ $ad->photo ? asset('assets/images/'.$ad->photo):'http://fulldubai.com/SiteImages/noimage.png'}}"
                                                     alt="Blog's Photo" id="adminimg">
                                            </div>
                                        </div>
                                        <div class="form-group">

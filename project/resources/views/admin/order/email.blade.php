                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                        ...
                                        <form class="form-horizontal" action="{{route('admin-order-emailsub')}}" method="POST">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" name="to" id="edit_language" placeholder="Email To Send" type="text" value="{{$order->customer_email}}" disabled=""{!!$gs->rtl == 1 ? "dir='rtl'":""!!}>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="edit_language">Subject*</label>
                                            <div class="col-sm-6">
                                              <input class="form-control" name="subject" id="edit_language" placeholder="Enter Subject" required="" type="text" value=""{!!$gs->rtl == 1 ? "dir='rtl'":""!!}>
                                            </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6"> 
                                              <textarea class="form-control" name="message" id="edit_profile_description" rows="10" style="resize: vertical;" placeholder="Enter  Message"{!!$gs->rtl == 1 ? "dir='rtl'":""!!}></textarea>
                                            </div>
                                          </div>
                                         <hr>

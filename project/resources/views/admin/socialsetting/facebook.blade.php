                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="product__header"  style="border-bottom: none;">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="disable/enable_about_page">Disable/Enable Facebook Login *</label>
                                            <div class="col-sm-3">
                                                <label class="switch">
                                                  <input type="checkbox" name="fcheck" value="1" {{$socialdata->fcheck==1?"checked":""}}>

                    ...
                    <div class="row">
                                        ...
                                        <div class="row reorder-xs">
                                            <div class="col-lg-8 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    <h2>Withdraw Details <a href="{{ route('admin-wtt-index') }}" style="padding: 5px 12px;" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a></h2>
                                                    <p>Dashboard <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Customers <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Withdraws <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Withdraw Details
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td width="30%" style="text-align: right;"><a href="{{route('admin-wtt-accept',$withdraw->id)}}" class="btn btn-success btn-xs"><i class="fa fa-check-circle"></i> Accept</a></td>

                                <td><a href="{{route('admin-wtt-reject',$withdraw->id)}}" class="btn btn-danger btn-xs"><i class="fa fa-times-circle"></i> Reject</a></td>
                                @endif
                            </tr>

                                        ...
                                        <form class="form-horizontal" action="{{route('admin-sl-edit',$ad->id)}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" name="link" id="link" placeholder="Enter link" required="" type="text" value="{{$ad->link}}">
                                                </div>
                                            </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" name="color" id="color" placeholder="#000000" required="" type="text" value="{{$ad->color}}">
                                                </div>
                                            </div>

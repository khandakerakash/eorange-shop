                                        ...
                                        <div class="row reorder-xs">
                                            <div class="col-lg-8 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    <h2>Social Links</h2>
                                                    <p>Dashboard <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Settings <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Social Links</p>
                                                </div>
                                            </div>
                                              @include('includes.user-notification')
                                        </div>   
                                    </div>
                                        <form class="form-horizontal" action="{{route('user-social-update')}}" method="POST">
                                         @include('includes.form-success')      
                                        {{csrf_field()}}
                                          <div class="form-group">
                                            <label class="control-label col-sm-3" for="facebook">Facebook *</label>
                                            <div class="col-sm-6">
                                              <input class="form-control" name="f_url" id="facebook" placeholder="http://facebook.com/" required="" type="text" value="{{$socialdata->f_url}}">
                                            </div>
                                            <div class="col-sm-3">
                                                <label class="switch">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" name="g_url" id="google-Plus" placeholder="http://google.com/" required="" type="text" value="{{$socialdata->g_url}}">
                                            </div>
                                            <div class="col-sm-3">
                                                <label class="switch">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" name="t_url" id="twiter" placeholder="http://twitter.com/" required="" type="text" value="{{$socialdata->t_url}}">
                                            </div>
                                            <div class="col-sm-3">
                                                <label class="switch">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" name="l_url" id="linkedin" placeholder="http://linkedin.com/" required="" type="text" value="{{$socialdata->l_url}}">
                                            </div>
                                            <div class="col-sm-3">
                                                <label class="switch">

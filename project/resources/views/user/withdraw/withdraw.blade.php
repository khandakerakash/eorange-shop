                        ...
                        @include('includes.form-success')
                                          ...
                                          {{csrf_field()}}
                                            ...
                                            <div class="item form-group">
                                                <label class="control-label col-sm-4" for="name">Current Earnings :

                                                </label>
                                                <div class="col-sm-6">
                                                    <div class="label label-success" style="font-size: 25px; background-color: #009432;">{{$currency_sign->sign}} <span>{{number_format($user->current_balance * $currency_sign->value,2)}}</span></div>
                                                </div>
                                            </div>
                                            <hr>
                                <div class="item form-group">

                                        ...
                                        <div class="row reorder-xs">
                                            <div class="col-lg-8 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    <h2>Withdraw Affiliate Bonus Now <a href="{{ route('user-wwt-index') }}" style="padding: 5px 12px;" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a></h2>
                        ...
                        @include('includes.form-success')
                                          ...
                                          {{csrf_field()}}
                                            ...
                                            <div class="item form-group">
                                                <label class="control-label col-sm-4" for="name">Current Affiliate Bonus :

                                                </label>
                                                <div class="col-sm-6">
                                                    <div class="label label-success" style="font-size: 25px; background-color: #009432;">{{$currency_sign->sign}} <span>{{number_format($user->affilate_income * $currency_sign->value,2)}}</span></div>
                                                </div>
                                            </div>
                                            <hr>
                                <div class="item form-group">

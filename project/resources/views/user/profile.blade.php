                        ...
                        <div class="section-padding add-product-1">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <img style="width: 100%; height: auto;" src="{{ $user->photo ? $user->photo:'http://fulldubai.com/SiteImages/noimage.png'}}" alt="profile image">
                                    @else
                                    <img  style="width: 100%; height: auto;" src="{{ $user->photo ? asset('assets/images/'.$user->photo):'http://fulldubai.com/SiteImages/noimage.png'}}" alt="profile image">
                                    @endif

                                        ...
                                        <div class="row reorder-xs">
                                            <div class="col-lg-8 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    <h2>Create Product <a href="{{ route('user-prod-index') }}" style="padding: 5px 12px;" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a></h2>
                                                    <p>Dashboard <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Products <i class="fa fa-angle-right" style="margin: 0 2px;"></i>Create</p>
                                                </div>
                                            </div>
                                            @include('includes.user-notification')
                                        </div>
                                    </div>
                                    <form class="form-horizontal" action="{{route('user-prod-store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="sku" id="sku" placeholder="Enter Product SKU" required="" type="text" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control" id="cat" name="brand_id">
                                                    <option value="" {!!$gs->rtl == 1 ? "dir='rtl'":""!!}>Select Brand</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <button type="button" id="uploadTrigger" onclick="uploadclick()" class="form-control"><i class="fa fa-download"></i> Add Featured Image</button>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="cprice" id="blood_group_display_name" placeholder="e.g 20" required="" type="text" {!!$gs->rtl == 1 ? "dir='rtl'":""!!}>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="pprice" id="blood_group_display_name" placeholder="e.g 25"  type="text" {!!$gs->rtl == 1 ? "dir='rtl'":""!!}>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="stock" id="blood_group_display_name" placeholder="e.g 15"  type="text" {!!$gs->rtl == 1 ? "dir='rtl'":""!!}>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="policy">Product Buy/Return Policy*</label>
                                            <div class="col-xs-12 col-sm-6">
                                                <textarea class="form-control" name="policy" id="policy" rows="5" style="resize: vertical;" placeholder="Enter Profile Description" {!!$gs->rtl == 1 ? "dir='rtl'":""!!}></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="email"></label>
                                                ...
                                                <div class="qualification-area">
                                                    <div class="form-group">
                                                        <div class="col-xs-10 col-sm-5 col-sm-offset-1">
                                                            <input class="form-control" name="features[]" placeholder="Name" type="text" value=""  {!!$gs->rtl == 1 ? "dir='rtl'":""!!}>
                                                        </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-3">
                                                            <div  class="input-group colorpicker-component">
                                                                <input type="text" name="colors[]" value="#000000"  class="form-control colorpick" {!!$gs->rtl == 1 ? "dir='rtl'":""!!} />
                                                                <span class="input-group-addon"><i></i></span>
                                                            </div>
                                                        </div>
                                                    </div>

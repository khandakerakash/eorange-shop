                            ...
                            <div class="row">
                                @foreach($vprods as $prod)
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        @endphp
                                        <a href="{{route('front.product',['id' => $prod->id, 'slug' => $name])}}" class="single-product-area vendor-product-area text-center">
                                            <div class="product-image-area">
                                                ...
                                                <img class="mx-auto d-block img-fluid" src="{{asset('assets/images/'.$prod->photo)}}" alt="new arrival product">

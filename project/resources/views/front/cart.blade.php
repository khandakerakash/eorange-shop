            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="table-responsive product-shoppingCart-table">
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr id="del{{$product['item']['id']}}">
                          <td><img class="img-thumbnail table-image" src="{{ asset('assets/images/'.$product['item']['photo']) }}" style="height: 100px; width: 100px;" alt="table image"></td>
                            <td>
                    ...
                    <input type="hidden" value="{{$product['item']['id']}}">    
                            ...
                            <td><i class="far fa-trash-alt" style="cursor: pointer; color: #ff3f34;" onclick="remove({{$product['item']['id']}})"></i></td>
                        </tr>
                            @endforeach
                            @else
                            <tr>
                      ...
                      @if(Session::has('cart'))
                        <tr>
                          <td colspan="7"></td>
                          <td><h3 class="cart-page-total" style="text-align: right;">{{$lang->vt}}</h3></td>
                          <td><h3 class="cart-page-total" style="text-align: right;">
                            @if($gs->sign == 0)
                            {{$curr->sign}}<span class="total cart-page-total" id="grandtotal">{{round($totalPrice * $curr->value, 2)}}</span>
                            @else
                            <span class="total cart-page-total" id="grandtotal">{{round($totalPrice * $curr->value, 2)}}</span>{{$curr->sign}}
                            @endif
                          </h3>
                          </td>
                        </tr>

                            ...
                            <div class="collapse in" id="borwse">
                                <ul class="filter-sidebar-wrap">
                                    <li class="filter-sidebar-item" v-for="(cate,index) in sub_category">
                                        <a class="filter-sidebar-link" href="#0" @click.prevent="getDataByCategory(cate.id)"><i class="fa fa-angle-right"></i> {{cate.name}}</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="category-content-items">
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6" v-for="(product,index) in dataGrid.data" >
                                    <a class="category_product-wrap" :href="route('front.product',[product.id,product.slug])+'?exclusive_offer='+(slug==='exclusive-offer'?1:0)">
                                        <div class="single-flash_item">
                                            ...
                                            <div>
                                                <a :href="route('front.product',[product.id,product.slug])+'?exclusive_offer='+(slug==='exclusive-offer'?1:0)" class="text-center">
...
<script>
    export default {
        ...
        methods:{
            ...
            getDataByCategory:function(cat){

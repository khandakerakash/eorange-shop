...
if (!isset($_POST['web_name']) || $_POST['web_name'] == ""){
  echo "Please Enter Website Name";
    ...
    $chkData = file_get_contents(constant("GENIUSOCEAN").'purchase112662update.php?code='.$purchase_code.'&domain='.$my_domain.'&script='.$my_script);

...
class PortfolioController extends Controller
{
  ...
  public function index()
    ...
    public function store(StoreValidationRequest $request)
    {
        ...
        $ad->fill($data)->save();
        return redirect()->route('admin-ad-index')->with('success','New Portfolio Added Successfully.');
    }
    ...
    public function update(StoreValidationRequest $request, $id)
    {
        ...
        $ad->update($data);
        return redirect()->route('admin-ad-index')->with('success','Portfolio Updated Successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        if($ad->photo == null){
        $ad->delete();
        return redirect()->route('admin-ad-index')->with('success','Portfolio Deleted Successfully.');
        }
                    if (file_exists(public_path().'/assets/images/'.$ad->photo)) {
                        unlink(public_path().'/assets/images/'.$ad->photo);
                    }
